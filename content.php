...
<div class="post_container">
	...
	<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
		...
		<div class ="format-image"><img src="<?php echo $root ;?>/images/formats/default.png" height="50px" width="50px" alt="default"/></div><h2 class="posts_title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
