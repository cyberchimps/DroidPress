...
<div class="post_container">
	...
	<div class ="format-image"><img src="<?php echo $root ;?>/images/formats/link.png" height="50px" width="50px" alt="link"/></div><h2 class="posts_title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
