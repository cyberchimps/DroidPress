...
<div id="footer">
    <div id="footer_wrap">
		...
		<div class="footer-widgets">
			<h3 class="footer-widget-title"><?php esc_html_e( 'Recent Posts', 'droidpress' ); ?></h3>
			<ul>
		...
		<div class="footer-widgets">
			<h3 class="footer-widget-title"><?php esc_html_e( 'Archives', 'droidpress' ); ?></h3>
			<ul>
		...
		<div class="footer-widgets">
			<h3 class="footer-widget-title"><?php esc_html_e( 'Links', 'droidpress' ); ?></h3>
			<ul>
		...
		<div class="footer-widgets">
			<h3 class="footer-widget-title"><?php esc_html_e( 'WordPress', 'droidpress' ); ?></h3>
			<ul>
    		<?php wp_register(); ?>
